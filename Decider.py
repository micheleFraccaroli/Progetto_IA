...
from tensorflow.python.keras.optimizers import (SGD, Adadelta, Adagrad, Adam,
                                                Adamax, Nadam, RMSprop)
...
class Decider:
    ...
    def launching(self):
        ...
        # read data from Digit folder and generate augmented data for training session
        ...
        # read data from Digit folder and generate augmented data for testing session
        ...
        # change dinamically the learning rate (in this case I use only -6 the for cycle is not necessary)
        for i in range(-6, -5):
            tensorboard = TensorBoard(
                log_dir="logs/{}".format(time()) + "-->" + str(i))
            print("\n" + str(i) + "\n")
            lr = math.exp(i)
            adam = Adamax(lr=lr)
            ...
            output_file = str(
                i) + " " + str(score[0]) + " " + str(score[1]) + " " + str(lr) + "\n"
            f.write(output_file)
            print("\nLoss: ", str(score[0]), "\nAcc: ", str(score[1]) + "\n")
...
if __name__ == '__main__':
    ...
    print(bcolors.MAGENTA +
          "\______ \   ____   ____ |__| __| _/___________ " + bcolors.ENDC)
    print(bcolors.OKBLUE +
          " |    |  \_/ __ \_/ ___\|  |/ __ |/ __ \_  __ \ " + bcolors.ENDC)
    print(bcolors.OKBLUE +
          " |    `   \  ___/\  \___|  / /_/ \  ___/|  | \/" + bcolors.ENDC)
